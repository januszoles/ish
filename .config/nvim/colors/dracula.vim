...
let g:bglighter = ['#424450', 238]
let g:bglight   = ['#343746', 237]
let g:bg        = ['#282A36', 236]
let g:bgdark    = ['#21222C', 235]
let g:bgdarker  = ['#191A21', 234]

let g:comment   = ['#6272A4',  61]
let g:selection = ['#44475A', 239]
let g:subtle    = ['#424450', 238]

let g:cyan      = ['#8BE9FD', 117]
let g:green     = ['#50FA7B',  84]
let g:orange    = ['#FFB86C', 215]
let g:pink      = ['#FF79C6', 212]
let g:purple    = ['#BD93F9', 141]
let g:red       = ['#FF5555', 203]
let g:yellow    = ['#F1FA8C', 228]
...
let s:bglighter = g:bglighter
let s:bglight   = g:bglight
let s:bg        = g:bg
let s:bgdark    = g:bgdark
let s:bgdarker  = g:bgdarker

let s:comment   = g:comment
let s:selection = g:selection
let s:subtle    = g:subtle

let s:cyan      = g:cyan
let s:green     = g:green
let s:orange    = g:orange
let s:pink      = g:pink
let s:purple    = g:purple
let s:red       = g:red
let s:yellow    = g:yellow
